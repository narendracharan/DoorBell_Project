...
const { loginUserApp, sendMailOtp, userAppVerify, resetUserAppPassword, userProfile, editUserProfile, aboutUserApp, userforgetPassword, faqsList, editImage } = require("../controllers/userController/userAppControllers")
...
router.post("/edit-profile/:id",userAuthorisationUser,upload.single("profilePic"),editImage)
